...
@set FILE=%1
@set SDL_PATH=Libs\SDL-main
@set SDL_IMAGE_PATH=Libs\SDL_image-main
...
@cl /nologo /Zi /EHsc /MDd ^
  ...
  /SUBSYSTEM:CONSOLE ^
  /OUT:AItest.exe > compile_log.txt 2>&1
...
@copy "%SDL_PATH%\lib\x64\SDL3.dll" . >nul 2>&1
@copy "%SDL_IMAGE_PATH%\lib\x64\SDL3_image.dll" . >nul 2>&1
